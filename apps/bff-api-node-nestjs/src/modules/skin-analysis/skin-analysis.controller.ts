...
@Controller('initiate-skin-analysis') // Rota base: http://localhost:3333/initiate-skin-analysis
export class SkinAnalysisController {
  constructor(private readonly wizardService: SkinAnalysisService) {}

  @Post('submit') // Sub-rota: POST http://localhost:3333/initiate-skin-analysis/submit
